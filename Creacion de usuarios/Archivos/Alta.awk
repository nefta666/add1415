...
dominio="OU=Formacion Profesional,DC=nrodrod,DC=add";
...
print "dsadd user -upn "usuario"@nrodrod.add \"CN="nombreordenado","unidad"\" -samid "usuario" -disabled no -pwd $M"clave"a# -mustchpwd yes -memberof \""grupo"\" -fn \""nombre"\" -ln \""apellido1" "apellido2"\" -display \""nombrecompleto"\" -q" > fichero
